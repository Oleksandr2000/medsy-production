const ArrowLeft = ({ color = "currentColor", width = "19px", height = "12px", ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 18.738 12" {...props}>
            <path
