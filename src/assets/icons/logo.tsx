const Logo = ({ id, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="144.392" height="31" viewBox="0 0 144.392 31" {...props}>
            <defs>
                <linearGradient id={id || "linear-gradient"} x2="1" y2="1" gradientUnits="objectBoundingBox">
