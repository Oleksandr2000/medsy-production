export const Facebook = ({ color = "currentColor", width = "15px", height = "15px" }) => {
    return (
...
export const Twitter = ({ color = "currentColor", width = "21px", height = "16px" }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 20.64 15.339">
            <path
                data-name="Path 1080"
...
export const Youtube = ({ color = "currentColor", width = "19px", height = "14px" }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 18.664 14">
            <path
...
export const Github = ({ color = "currentColor", width = "14px", height = "14px" }) => {
    return (
...
export const Instagram = ({ color = "currentColor", width = "14px", height = "14px" }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 14 14">
            <path
                data-name="Path 1083"
...
export const Linkedin = ({ color = "currentColor", width = "14px", height = "14px" }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 14 14">
            <path
