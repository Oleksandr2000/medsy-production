...
export const ButtonDisable =
    "text-gray-500 bg-gray-300 cursor-not-allowed hover:bg-gray-300 dark:bg-gray-600 dark:text-dark";
...
export const TextBoxDisable =
    "text-gray-500 cursor-not-allowed hover:bg-gray-300 hover:border-transparent focus:border-transparent focus:placeholder-gray-500";

export const TextBoxEnable = "text-gray-900 hover:border-gray-400 focus:border-black focus:placeholder-gray-900";
...
export const CartItemBase =
    "w-full h-auto flex justify-start items-center bg-white px-3 py-6 border-b border-gray-200 dark:border-gray-800 relative last:border-b-0 dark:bg-darkTheme-bg";

export const CartItemImage = "flex w-105px h-105px rounded overflow-hidden bg-gray-200 mr-15px flex-shrink-0";

export const CartItemContent = "flex flex-col w-full px-2";

export const CartItemName = "text-13px text-gray-900 dark:text-gray-400";

export const CartItemSinglePrice = "text-13px text-gray-500 mt-5px mb-10px dark:text-gray-600";

export const CartItemTotalPrice = "font-semibold text-16px text-gray-900 flex-shrink-0 dark:text-gray-300 mb-3 xs:mb-0";
...
export const ItemCardImage =
    "flex relative aspect-square justify-center bg-gray-200 dark:bg-gray-400 items-center w-full rounded overflow-hidden";
export const ItemCardContent = "flex flex-col items-start mt-3 dark:text-gray-500";
export const ItemCardPrice = "font-semibold text-gray-900 mb-2 text-16px dark:text-gray-400";
