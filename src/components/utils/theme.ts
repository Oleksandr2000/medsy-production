...
export const TextBoxEnable =
  "text-gray-900 hover:border-gray-400 focus:border-black focus:placeholder-gray-900";
...
export const CartItemSinglePrice =
  "text-13px text-gray-500 mt-5px mb-10px dark:text-gray-600";

export const CartItemTotalPrice =
  "font-semibold text-16px text-gray-900 flex-shrink-0 dark:text-gray-300 mb-3 xs:mb-0";
...
export const ItemCardContent =
  "flex flex-col items-start mt-3 dark:text-gray-500";
export const ItemCardPrice =
  "font-semibold text-gray-900 mb-2 text-16px dark:text-gray-400";
